...
- `rag/graphrag/entity_resolution.py` — duplicate entity merge pass and PageRank refresh.
- `rag/graphrag/general/community_reports_extractor.py` — community report generation.
